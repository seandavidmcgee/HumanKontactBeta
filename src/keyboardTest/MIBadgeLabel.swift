...
//        CGContextSetFillColorWithColor(ctx, UIColor.whiteColor().CGColor)
        ...
        var attributes: NSMutableDictionary = [NSFontAttributeName: font, NSForegroundColorAttributeName : UIColor.whiteColor(), NSParagraphStyleAttributeName:paragraphStyle]

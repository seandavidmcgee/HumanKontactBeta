...
//        CGContextSetFillColorWithColor(ctx, UIColor.whiteColor().CGColor)
        ...
        let font: UIFont = UIFont(name: "AvenirNext-Regular", size: 13.0)!
        let textSize: CGSize  = labelString.sizeWithAttributes([NSFontAttributeName : font])
        ...
        let attributes = [NSFontAttributeName: font, NSForegroundColorAttributeName : UIColor.whiteColor(), NSParagraphStyleAttributeName:paragraphStyle] as [NSObject : AnyObject]
        
        labelString.drawInRect(textFrame, withAttributes: attributes as? [String : AnyObject] )
    }

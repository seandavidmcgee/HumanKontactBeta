...
class MMSampleTableViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,MMPlayPageScroll ,UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        imageArr.append(UIImage(named: "concert.jpg")!)
        imageArr.append(UIImage(named: "fashion.jpg")!)
        imageArr.append(UIImage(named: "festival.jpg")!)
        imageArr.append(UIImage(named: "fun.jpg")!)
        imageArr.append(UIImage(named: "mud.jpg")!)
    }
    ...
    func initHeadr(){
        ...
        case 2:
            ...
            //headerImage.image=UIImage(named: "sports")?.imageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate)
             imageArr.removeAll()
             imageArr.append(UIImage(named: "colbert.jpg")!)
             imageArr.append(UIImage(named: "cow.jpg")!)
             imageArr.append(UIImage(named: "eminem.jpg")!)
             imageArr.append(UIImage(named: "pontoon.jpg")!)
             imageArr.append(UIImage(named: "survivor.jpg")!)
            break

...
class BallView: UIView {
    ...
    func endAnimation(completion:(()->())? = nil) {
...
class CircleLayer :CAShapeLayer {
    ...
    init(size:CGFloat, moveUpDist:CGFloat , superViewFrame:CGRect, color:UIColor = UIColor.whiteColor()) {
        ...
        self.fillColor = UIColor.whiteColor().colorWithAlphaComponent(1).CGColor
...
class SpinerLayer :CAShapeLayer {
    ...
    init(superLayerFrame:CGRect, ballSize:CGFloat, color:UIColor = UIColor.whiteColor()) {
        ...
        self.fillColor = nil
        self.strokeColor = UIColor.whiteColor().colorWithAlphaComponent(1).CGColor
        self.lineWidth = 2

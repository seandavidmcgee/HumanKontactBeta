...
//        bannerImage.contentMode=UIViewContentMode.ScaleAspectFill
        ...
        menuBut.setImage(UIImage(named: "back2")?.imageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate), forState: UIControlState.Normal)
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        images=Array()
        images.append(UIImage(named: "concert.jpg")!)
        images.append(UIImage(named: "fashion.jpg")!)
        images.append(UIImage(named: "festival.jpg")!)
        images.append(UIImage(named: "fun.jpg")!)
        images.append(UIImage(named: "mud.jpg")!)

...
var fontAttrs: [String: UIFont]!
var baseKey: String = ""
var keyEntry: String = ""
var returnFromResults: Bool! = false

class KeyboardController: WKInterfaceController {
    @IBOutlet weak var searchLabel: WKInterfaceLabel!
    ...
    override func willActivate() {
        ...
        if !activeSearch.isEmpty {
            ...
            self.searchLabel.setAttributedText(attrString)
        }
        if returnFromResults == true {
            self.dynamicKeyboardLayout()
